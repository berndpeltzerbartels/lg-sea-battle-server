...
public class SeaBattleClientController {
    ...
    public ResponseEntity<?> fireTorpedo(@RequestBody FireTorpedoRequest request) {
        ...
        GameSnapshot after = gameStateService.fireTorpedo(new FireTorpedoRequest(
                request.playerId(),
                teamId,
                request.vehicleType(),
                request.x(),
    ...
    public ResponseEntity<?> fireCannon(@RequestBody FlakFireRequest request) {
        ...
        return ResponseEntity.ok(gameStateService.fireCannon(new FlakFireRequest(
                request.playerId(),
                teamId,
                request.shipId(),
                request.x(),
    ...
    @Post("/game/client-event")
    public ResponseEntity<?> reportClientEvent(@RequestBody ClientGameEventReport report) {
        diagnosticsService.logClientGameEvent(report);
        return ResponseEntity.noContent();
    }
