...
final class NavigationService {
    ...
    boolean isShipBlocked(Vector2 position, double heading, WorldMap worldMap) {
        return shipPoint(position, heading, 4.9, 0, worldMap)
                || shipPoint(position, heading, 3.2, -0.62, worldMap)
                || shipPoint(position, heading, 3.2, 0.62, worldMap)
                || shipPoint(position, heading, 1.0, -0.74, worldMap)
                || shipPoint(position, heading, 1.0, 0.74, worldMap)
                || shipPoint(position, heading, -1.0, -0.62, worldMap)
                || shipPoint(position, heading, -1.0, 0.62, worldMap)
                || shipPoint(position, heading, 0, 0, worldMap);
    }
