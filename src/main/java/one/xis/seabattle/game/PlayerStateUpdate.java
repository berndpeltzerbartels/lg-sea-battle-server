...
public record PlayerStateUpdate(
    ...
    public PlayerStateUpdate(String playerId, String teamId, double x, double z, double heading, double speed,
                             ...
                             Double flakYaw, Double flakPitch, Double cannonYaw, Double cannonPitch) {
        this(playerId, teamId, x, z, heading, speed, turnVelocity, engineOrder, rudderDegrees, clientTime,
                debugTeleport, vehicleType, y, verticalSpeed, flakYaw, flakPitch, cannonYaw, cannonPitch, "surface");
    }
    ...
    public PlayerStateUpdate(String playerId, String teamId, double x, double z, double heading, double speed,
        ...
        this(playerId, teamId, x, z, heading, speed, turnVelocity, engineOrder, rudderDegrees, clientTime,
                debugTeleport, vehicleType, 0, 0, null, null, null, null, "surface");
    }
    ...
    public PlayerStateUpdate(String playerId, String teamId, double x, double z, double heading, double speed,
                             ...
                             boolean debugTeleport) {
        this(playerId, teamId, x, z, heading, speed, turnVelocity, engineOrder, rudderDegrees, clientTime,
                debugTeleport, "torpedo-boat", 0, 0, null, null, null, null, "surface");
    }
    ...
    public PlayerStateUpdate(String playerId, String teamId, double x, double z, double heading, double speed,
        ...
        this(playerId, teamId, x, z, heading, speed, turnVelocity, engineOrder, rudderDegrees, clientTime,
                debugTeleport, vehicleType, y, 0, null, null, null, null, "surface");
    }
    ...
    public PlayerStateUpdate(String playerId, String teamId, double x, double z, double heading, double speed,
                             ...
                             boolean debugTeleport, String vehicleType, double y, double verticalSpeed) {
        this(playerId, teamId, x, z, heading, speed, turnVelocity, engineOrder, rudderDegrees, clientTime,
                debugTeleport, vehicleType, y, verticalSpeed, null, null, null, null, "surface");
    }
}
